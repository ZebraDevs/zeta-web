import { css as b, LitElement as q, html as v, svg as Et, nothing as dt } from "lit";
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, st = J.ShadowRoot && (J.ShadyCSS === void 0 || J.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, xt = Symbol(), ht = /* @__PURE__ */ new WeakMap();
let It = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = !0, s !== xt)
...
const Ot = (o) => new It(typeof o == "string" ? o : o + "", void 0, xt), kt = (o, t) => {
  if (st)
...
}, pt = st ? (o) => o : (o) => o instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ft, defineProperty: Lt, getOwnPropertyDescriptor: Rt, getOwnPropertyNames: Ht, getOwnPropertySymbols: Kt, getPrototypeOf: qt } = Object, S = globalThis, ut = S.trustedTypes, Ut = ut ? ut.emptyScript : "", $ = S.reactiveElementPolyfillSupport, L = (o, t) => o, N = { toAttribute(o, t) {
  switch (t) {
    case Boolean:
      o = o ? Ut : null;
      break;
  ...
  return e;
} }, ot = (o, t) => !Ft(o, t), vt = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: ot };
...
class k extends HTMLElement {
  ...
  _$EO(t, e) {
    ...
    if (r !== void 0 && s.reflect === !0) {
      const n = (((i = s.converter) == null ? void 0 : i.toAttribute) !== void 0 ? s.converter : N).toAttribute(e, s.type);
  ...
  _$AK(t, e) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = s.getPropertyOptions(r), l = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((i = n.converter) == null ? void 0 : i.fromAttribute) !== void 0 ? n.converter : N;
      this._$Em = r, this[r] = l.fromAttribute(e, n.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, s, r = !1, i) {
    if (t !== void 0) {
      if (s ?? (s = this.constructor.getPropertyOptions(t)), !(s.hasChanged ?? ot)(r ? i : this[t], e))
        return;
      this.C(t, e, s);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (r.size > 0)
        for (const [i, n] of r)
          n.wrapped !== !0 || this._$AL.has(i) || this[i] === void 0 || this.C(i, this[i], n);
    }
    let t = !1;
    const e = this._$AL;
    try {
...
k.elementStyles = [], k.shadowRootOptions = { mode: "open" }, k[L("elementProperties")] = /* @__PURE__ */ new Map(), k[L("finalized")] = /* @__PURE__ */ new Map(), $ == null || $({ ReactiveElement: k }), (S.reactiveElementVersions ?? (S.reactiveElementVersions = [])).push("2.0.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wt = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: ot }, Zt = (o = Wt, t, e) => {
  ...
  if (i === void 0 && globalThis.litPropertyMetadata.set(r, i = /* @__PURE__ */ new Map()), i.set(e.name, o), s === "accessor") {
    ...
    return { set(l) {
      ...
      return l !== void 0 && this.C(n, void 0, o), l;
    } };
  }
  if (s === "setter") {
    const { name: n } = e;
...
function Jt(o, t) {
  return (e, s, r) => {
    ...
    if (t) {
      const { get: n, set: l } = typeof s == "object" ? e : r ?? (() => {
        const a = Symbol();
        return { get() {
          return this[a];
        }, set(d) {
...
function nt(o) {
  return (t, e) => {
    const { slot: s, selector: r } = o ?? {}, i = "slot" + (s ? `[name=${s}]` : ":not([name])");
    return rt(t, e, { get() {
      var a;
      const n = (a = this.renderRoot) == null ? void 0 : a.querySelector(i), l = (n == null ? void 0 : n.assignedElements(o)) ?? [];
      return r === void 0 ? l : l.filter((d) => d.matches(r));
    } });
  };
}
var Nt = Object.defineProperty, Qt = Object.getOwnPropertyDescriptor, Gt = (o, t, e, s) => {
  for (var r = s > 1 ? void 0 : s ? Qt(t, e) : t, i = o.length - 1, n; i >= 0; i--)
...
var Tt = Object.defineProperty, Xt = Object.getOwnPropertyDescriptor, Yt = (o, t, e, s) => {
...
St(q);
const Mt = it(at(St(q)));
var ve = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, W = (o, t, e, s) => {
  for (var r = s > 1 ? void 0 : s ? fe(t, e) : t, i = o.length - 1, n; i >= 0; i--)
    (n = o[i]) && (r = (s ? n(t, e, r) : n(r)) || r);
...
ct.styles = [de, Mt.styles || []];
let y = class extends ct {
  constructor() {
    super(...arguments), this.name = "", this.value = "", this.flavor = "primary";
  }
  focus() {
    var o;
    (o = this.buttonElement) == null || o.focus();
  }
  blur() {
    var o;
    (o = this.buttonElement) == null || o.blur();
  }
  static get styles() {
    return [super.styles ?? []];
  }
...
var ge = Object.defineProperty, me = Object.getOwnPropertyDescriptor, ye = Object.getPrototypeOf, be = Reflect.get, O = (o, t, e, s) => {
  for (var r = s > 1 ? void 0 : s ? me(t, e) : t, i = o.length - 1, n; i >= 0; i--)
    (n = o[i]) && (r = (s ? n(t, e, r) : n(r)) || r);
  return s && r && ge(t, e, r), r;
}, Ae = (o, t, e) => be(ye(o), e, t);
  ...
  constructor() {
    super(...arguments), this.title = "", this.body = "", this.status = "default", this.getIcon = () => {
      ...
      if (this.requestUpdate(), this.leadingAction[0] && this.leadingAction[0] instanceof y) {
        const o = this.leadingAction[0];
        o.flavor = "outline-subtle", o.rounded = this.rounded, o.condensed = this.condensed;
      }
      if (this.trailingAction[0] && this.trailingAction[0] instanceof y) {
        const o = this.trailingAction[0];
        o.flavor = "outline-subtle", o.rounded = this.rounded, o.condensed = this.condensed;
      }
    };
  }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R = globalThis, Q = R.trustedTypes, ft = Q ? Q.createPolicy("lit-html", { createHTML: (o) => o }) : void 0, Vt = "$lit$", x = `lit$${(Math.random() + "").slice(9)}$`, Bt = "?" + x, Ce = `<${Bt}>`, D = document, G = () => D.createComment(""), H = (o) => o === null || typeof o != "object" && typeof o != "function", wt = Array.isArray, Pe = (o) => wt(o) || typeof (o == null ? void 0 : o[Symbol.iterator]) == "function", tt = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, gt = /-->/g, mt = />/g, V = RegExp(`>|${tt}(?:([^\\s"'>=/]+)(${tt}*=${tt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), yt = /'/g, bt = /"/g, Dt = /^(?:script|style|textarea|title)$/i, C = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), At = /* @__PURE__ */ new WeakMap(), B = D.createTreeWalker(D, 129);
function Ct(o, t) {
...
const Ee = (o, t) => {
  ...
  for (let l = 0; l < e; l++) {
    ...
    for (; g < a.length && (n.lastIndex = g, u = n.exec(a), u !== null); )
      g = n.lastIndex, n === F ? u[1] === "!--" ? n = gt : u[1] !== void 0 ? n = mt : u[2] !== void 0 ? (Dt.test(u[2]) && (r = RegExp("</" + u[2], "g")), n = V) : u[3] !== void 0 && (n = V) : n === V ? u[0] === ">" ? (n = r ?? F, c = -1) : u[1] === void 0 ? c = -2 : (c = n.lastIndex - u[2].length, d = u[1], n = u[3] === void 0 ? V : u[3] === '"' ? bt : yt) : n === bt || n === yt ? n = V : n === gt || n === mt ? n = F : (n = V, r = void 0);
    const A = n === V && o[l + 1].startsWith("/>") ? " " : "";
    i += n === F ? a + Ce : c >= 0 ? (s.push(d), a.slice(0, c) + Vt + a.slice(c) + x + A) : a + x + (c === -2 ? l : A);
  }
  return [Ct(o, i + (o[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class K {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const l = t.length - 1, a = this.parts, [d, u] = Ee(t, e);
      ...
      if (r.nodeType === 1) {
        if (r.hasAttributes())
          for (const c of r.getAttributeNames())
            if (c.endsWith(Vt)) {
              const g = u[n++], A = r.getAttribute(c).split(x), Z = /([.?@])?(.*)/.exec(g);
              a.push({ type: 1, index: i, name: Z[2], strings: A, ctor: Z[1] === "." ? Oe : Z[1] === "?" ? ke : Z[1] === "@" ? Fe : Y }), r.removeAttribute(c);
            } else
              c.startsWith(x) && (a.push({ type: 6, index: i }), r.removeAttribute(c));
        if (Dt.test(r.tagName)) {
          const c = r.textContent.split(x), g = c.length - 1;
          if (g > 0) {
            r.textContent = Q ? Q.emptyScript : "";
            for (let A = 0; A < g; A++)
              r.append(c[A], G()), B.nextNode(), a.push({ type: 2, index: ++i });
            r.append(c[g], G());
          }
        }
        ...
        if (r.data === Bt)
          ...
          let c = -1;
          for (; (c = r.data.indexOf(x, c + 1)) !== -1; )
            a.push({ type: 7, index: i }), c += x.length - 1;
        }
      i++;
    }
  }
...
class Ie {
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, r = ((t == null ? void 0 : t.creationScope) ?? D).importNode(e, !0);
    B.currentNode = r;
    let i = B.nextNode(), n = 0, l = 0, a = s[0];
    for (; a !== void 0; ) {
      if (n === a.index) {
        let d;
        a.type === 2 ? d = new X(i, i.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(i, a.name, a.strings, this, t) : a.type === 6 && (d = new Le(i, this, t)), this._$AV.push(d), a = s[++l];
      }
...
class X {
  ...
  _$AI(t, e = this) {
    t = P(this, t, e), H(t) ? t === p || t == null || t === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : t !== this._$AH && t !== C && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Pe(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== p && H(this._$AH) ? this._$AA.nextSibling.data = t : this.$(D.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var i;
    ...
    if (((i = this._$AH) == null ? void 0 : i._$AD) === r)
      ...
      const n = new Ie(r, this), l = n.u(this.options);
  ...
  T(t) {
    ...
    let s, r = 0;
    for (const i of t)
      r === e.length ? e.push(s = new X(this.k(G()), this.k(G()), this, this.options)) : s = e[r], s._$AI(i), r++;
...
class Y {
  ...
  _$AI(t, e = this, s, r) {
    ...
    let n = !1;
    if (i === void 0)
      t = P(this, t, e, 0), n = !H(t) || t !== this._$AH && t !== C, n && (this._$AH = t);
    else {
      const l = t;
      let a, d;
      for (t = i[0], a = 0; a < i.length - 1; a++)
        d = P(this, l[s + a], e, a), d === C && (d = this._$AH[a]), n || (n = !H(d) || d !== this._$AH[a]), d === p ? t = p : t !== p && (t += (d ?? "") + i[a + 1]), this._$AH[a] = d;
    }
    n && !r && this.O(t);
  }
  O(t) {
...
et == null || et(K, X), (R.litHtmlVersions ?? (R.litHtmlVersions = [])).push("3.0.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Re = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, He = (o) => (...t) => ({ _$litDirective$: o, values: t });
let Ke = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pt = "important", qe = " !" + Pt, Ue = He(class extends Ke {
  constructor(o) {
    var t;
    if (super(o), o.type !== Re.ATTRIBUTE || o.name !== "style" || ((t = o.strings) == null ? void 0 : t.length) > 2)
  ...
  update(o, [t]) {
    ...
    for (const s in t) {
      ...
      if (r != null) {
        ...
        s.includes("-") || i ? e.setProperty(s, i ? r.slice(0, -11) : r, i ? Pt : "") : e[s] = r;
      }
    }
    return C;
  }
});
var We = Object.defineProperty, Ze = Object.getOwnPropertyDescriptor, z = (o, t, e, s) => {
  for (var r = s > 1 ? void 0 : s ? Ze(t, e) : t, i = o.length - 1, n; i >= 0; i--)
    (n = o[i]) && (r = (s ? n(t, e, r) : n(r)) || r);
...
let E = class extends jt {
  ...
  render() {
    ...
    return v` <span class="icon ${this.rounded ? "rounded" : "sharp"}" style=${o}>
