...
//TODO: This render method may need to change for react
  render: args =>
    <ZetaSystemBanner {...args} >
      <div slot="leading icon"><svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
//TODO: This render method may need to change for react
  render: args => <ZetaSystemBanner {...args} >
      ...
      </div><div slot="trailing icon"><svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
