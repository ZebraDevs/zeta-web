...
export const GroupItem: StoryObj = {
  render: args => {
    return html`
      <zeta-button-group-item size=${args.size} @click=${args.onclick} .disabled=${args.disabled} .rounded=${args.rounded} ?showDropdown=${args.showDropdown} flavor=${args.flavor} name=${args.name}>
