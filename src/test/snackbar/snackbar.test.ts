...
describe("zeta-snackbar", () => {
  ...
  const createComponent = (template = `<zeta-snackbar actionLabel="Action" status="default" hasCloseAction><zeta-icon slot="icon">happy</zeta-icon>Message</zeta-snackbar>`) => {
